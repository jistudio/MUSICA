 (function(global, $) {
        ...
        TabMenu.prototype.closeTab = function(initial_padding) {
            this.is_open = false;
            this.$overlay.fadeOut();
            this.$tab_menu.animate({
                
                'paddingBottom': this.initial_padding + '%'
